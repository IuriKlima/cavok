...
export default function ClientAeronave({ aeronave, relacionadas }) {
  ...
  const jsonLd = {
    ...
    "name": aeronave.nome,
    "image": allImages,
    "description": aeronave.descricaoCurta || aeronave.nome,
    "sku": aeronave.id,
    "brand": {
      "@type": "Brand",
      "name": aeronave.marca?.nome || "Cavok Avionics"
    },
    "offers": {
      "@type": "Offer",
      "url": `https://cavokavionics.com.br/aeronaves/${aeronave.slug}`,
      "priceCurrency": "BRL",
      "price": aeronave.preco || "0.00",
      "itemCondition": "https://schema.org/UsedCondition",
      "availability": aeronave.status === 'DISPONIVEL' ? "https://schema.org/InStock" : "https://schema.org/SoldOut"
    }
  };
